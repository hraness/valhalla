...
for (const name of ["styles.css", "icon.png", "apple-icon.png", "social.png", "robots.txt", "sitemap.xml", "llms.txt", "install.sh", "valhalla-mark.svg"]) await cp(resolve(root, name), resolve(output, name));
