...
- `pages.ts` owns documentation pages with their Diátaxis kinds; `compare.ts` owns comparison and use-case pages; `docs.ts` renders every collection with grouped navigation, breadcrumbs and per-page JSON-LD.
