...
test('readiness and privacy limitations stay discoverable from the home page', () => {
  ...
  for(const phrase of ['4,096', '30 seconds', '512', 'Incremental finalization', 'Status/Stage hints never advance permanent retention', 'independent-machine', 'not a deployed']) {
