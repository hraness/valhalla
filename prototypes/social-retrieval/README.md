...
```sh
/Users/bg/.bun/bin/oompa-host-run --mode=shared --lane=compute --label=valhalla-retrieval-native-fixture -- /bin/sh /Users/bg/Documents/Codex/valhalla/prototypes/social-retrieval/verify-native.sh
```
