...
/Users/bg/.bun/bin/oompa-host-run --mode=shared --lane=compute --label=valhalla-discovery-measure -- /bin/sh /Users/bg/Documents/Codex/valhalla/prototypes/social-discovery/measure.sh
```
