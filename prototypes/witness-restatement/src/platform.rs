...
///
/// ```compile_fail
/// use witness_restatement::platform::RunCapability;
/// fn dup(cap: &RunCapability) -> RunCapability { cap.clone() }
/// ```
///
/// ```compile_fail
/// use witness_restatement::platform::{RunCapability, RunRole, WorkAllowance};
...
///
/// ```compile_fail
/// use witness_restatement::platform::WitnessReceipt;
