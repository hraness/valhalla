...
| Platonik session adapter: game manifests, signed records, host-ordered sessions over the ledger, replay-checked checkpoints, the receiver, settlement, and member replacement | [game-platonik](../crates/vhalla-game-platonik/README.md), optional `std` adapter; bounded artifacts follow |
